...
{
    static bool estimate(Image* image_prev, Image* image, cv::Mat_<double>& H, std::vector<cv::DMatch>& matches_inliers, double& rep_error, double hom_delta = 7.0, TransformType type = SIMILARITY);
};
